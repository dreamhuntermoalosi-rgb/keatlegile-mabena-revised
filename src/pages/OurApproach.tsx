...
export const OurApproach: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Hero Header */}
      <section className="relative bg-[#004C4C] text-white py-20 border-b-2 border-[#D4AF37] overflow-hidden">
      ...
      <section className="py-12 bg-[#006666] text-white border-y-2 border-[#D4AF37]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
            ...
            <Link
              ...
              className="px-6 py-3 bg-[#D4AF37] hover:bg-[#A88616] text-[#1C1C1C] font-bold text-xs uppercase tracking-widest rounded-sm shrink-0 shadow border border-[#E2C45C]"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {steps.map((s, idx) => (
              <motion.div
                ...
                className="bg-white p-8 rounded-sm border-2 border-[#D4AF37]/30 shadow-md hover:shadow-2xl hover:border-[#006666] transition-all relative overflow-hidden group"
              >
                <div className="absolute top-4 right-4 text-4xl font-serif font-bold text-[#D4AF37]/30 group-hover:text-[#006666]/20 transition-colors">
                  {s.number}
                </div>

                <div className="w-12 h-12 bg-[#006666]/10 text-[#006666] group-hover:bg-[#006666] group-hover:text-white rounded-sm flex items-center justify-center transition-colors mb-6">
                  <s.icon className="w-6 h-6" />
                </div>

                <h3 className="font-serif text-2xl font-bold text-[#004C4C] mb-2">
                  {s.title}
                </h3>
                ...
                <div className="pt-4 border-t border-gray-100 flex items-start gap-2 text-[11px] text-[#006666] font-semibold">
      ...
      <section className="py-20 bg-[#F8F5EF] border-t border-[#006666]/10 text-[#1C1C1C]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 bg-white p-8 rounded-sm border-2 border-[#D4AF37] shadow-xl space-y-4">
            <h3 className="font-serif text-xl font-bold text-[#006666] border-b border-gray-100 pb-2">
            ...
            <div className="pt-4">
              <Link
                to="/start-a-conversation"
                className="w-full py-3 bg-[#006666] hover:bg-[#004C4C] text-white text-xs font-bold uppercase tracking-widest rounded-sm text-center block shadow transition-colors border border-[#D4AF37]/40"
              >
                Connect With Us
              </Link>
            </div>

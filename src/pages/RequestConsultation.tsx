...
Please contact me regarding a legal consultation.`;
  ...
  return (
    <>
      ...
      {/* Hero Header */}
      <section className="relative bg-[#7e2e19] text-white py-16 border-b-2 border-[#D4AF37] overflow-hidden">
      ...
      <section className="py-20 bg-white text-[#1C1C1C]">
        <div className="max-w-4xl mx-auto px-4 sm:px-8">
          <div className="bg-white p-8 sm:p-12 rounded-sm border-2 border-[#D4AF37] shadow-2xl space-y-8">
            {step === 'form' ? (
              <>
                <div className="border-b-2 border-gray-100 pb-4 space-y-2">
                ...
                <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xs font-bold uppercase tracking-wider text-[#9a3820] border-b-2 border-gray-100 pb-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-sm text-xs sm:text-sm focus:outline-none focus:border-[#9a3820]"
                        />
                        {errors.fullName && (
                  ...
                  <div className="pt-4">
                    <button
                      type="submit"
                      className="w-full py-4 bg-[#9a3820] hover:bg-[#7e2e19] text-white font-bold text-xs uppercase tracking-widest rounded-sm shadow-xl transition-colors border border-[#D4AF37]/40 flex items-center justify-center gap-2"
                    >
              ...
              <div className="space-y-6">
                <div className="border-b-2 border-gray-100 pb-4 space-y-1">
                  <span className="text-xs font-bold text-[#9a3820] uppercase tracking-wider">

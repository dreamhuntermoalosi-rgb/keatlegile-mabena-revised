      ...
      <section className="py-16 bg-white text-[#1C1C1C]">
        <div className="max-w-4xl mx-auto px-4 sm:px-8 space-y-8 bg-white p-8 sm:p-12 rounded-sm border border-[#D74B27]/30 shadow-lg">
          <div className="border-b-2 border-gray-100 pb-4 space-y-2">
            ...
            <h1 className="font-serif text-3xl sm:text-4xl font-bold text-[#7e2e19]">
          ...
          <div className="space-y-6 text-xs sm:text-sm text-[#1C1C1C]/80 leading-relaxed">
            <section className="space-y-2">
              <h2 className="font-serif text-xl font-bold text-[#9a3820]">1. Introduction &amp; Commitment to Privacy</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="font-serif text-xl font-bold text-[#9a3820]">2. Information We Collect</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="font-serif text-xl font-bold text-[#9a3820]">3. Purpose of Processing Personal Data</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="font-serif text-xl font-bold text-[#9a3820]">4. Information Contact</h2>
              <p>
